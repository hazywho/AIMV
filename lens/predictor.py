...
class protocol(spi1=spi1,disp_height=disp_height,disp_width=disp_width,reset = machine.Pin(st7789_res,machine.Pin.OUT)
               ,dc=machine.Pin(st7789_dc, machine.Pin.OUT),xstart=0, ystart=0, rotation=0):
    def __init__(self):
        self.display = st7789.ST7789(self.spi1, self.isp_width, self.disp_width,
