...
class client():
    def __init__(self, PORT=8000, HOST=""):
        self.s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM) #changed from SOCKSTREAM to SOCKDGRAM. This may improve speed at the cost of security, meaning more errors occur
